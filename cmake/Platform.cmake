...
if(NOT WIN32 AND NOT CMAKE_SYSTEM_NAME STREQUAL "Linux")
    message(FATAL_ERROR "Harmonia supports only Windows and Linux.")
endif()

function(harmonia_configure_target target)
    ...
    if(WIN32)
        target_compile_definitions(${target} INTERFACE
            NOMINMAX
            WIN32_LEAN_AND_MEAN
            HARMONIA_PLATFORM_WINDOWS=1
        )
    else()
        target_compile_definitions(${target} INTERFACE HARMONIA_PLATFORM_LINUX=1)
    endif()
endfunction()
